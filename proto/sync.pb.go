...
var file_proto_sync_proto_rawDesc = string([]byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa4, 0x01, 0x0a, 0x0b, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x65,
	...
	0x79, 0x6e, 0x63, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x08, 0x5a, 0x06,
...
var file_proto_sync_proto_depIdxs = []int32{
	...
	1, // 4: sync.AuthService.Login:output_type -> sync.LoginResponse
	4, // 5: sync.SyncService.UploadFile:output_type -> sync.UploadResponse
	2, // 6: sync.SyncService.DownloadFile:output_type -> sync.FileChunk
	5, // 7: sync.SyncService.ListFiles:output_type -> sync.FileList
